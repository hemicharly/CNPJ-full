...
Exemplos: python cnpj.py "database/F.K032001K.D81106D" sqlite "output"
          python cnpj.py "database" sqlite "output" --dir
          python cnpj.py "database" sqlite "output" --dir --noindex
          python cnpj.py "database" csv "output" --dir
    ''')
